<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = $('#tb').DataTable({
            ajax: "<?php echo base_url(); ?>rumahdinas/ajaxlist",
            ordering:false
        });
    });
    ...
    function save() {
        ...
        if (nama === '') {
            ...
            var url = "";
            if (save_method === 'add') {
                url = "<?php echo base_url(); ?>rumahdinas/ajax_add";
            } else {
                url = "<?php echo base_url(); ?>rumahdinas/ajax_edit";
            }
            $.ajax({
                url: url,
                type: "POST",
    ...
    function hapus(id, no) {
        if (confirm("Apakah anda yakin menghapus rumah dinas nomor " + no + " ?")) {
            $.ajax({
                url: "<?php echo base_url(); ?>rumahdinas/hapus/" + id,
                type: "POST",
                dataType: "JSON",
                success: function (data) {
    ...
    function ganti(id) {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>rumahdinas/ganti/" + id,
            type: "POST",
            dataType: "JSON",
            success: function (data) {
