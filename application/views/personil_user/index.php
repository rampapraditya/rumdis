<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = $('#tb').DataTable({
            ajax: "<?php echo base_url(); ?>profileuser/ajaxkeluarga/<?php echo $iduser; ?>",
            ordering:false
        });
    });
    
    function simpandepan() {
        var kode = document.getElementById('key').value;
        ...
        if (nrp === '') {
            ...
            $('#btnSaveDepan').text('Saving...'); 
            $('#btnSaveDepan').attr('disabled');
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#btnSaveDepan').text('Save');
                    $('#btnSaveDepan').attr('disabled', false);
    ...
    function simpan() {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>profileuser/prosesdetil",
            dataType: 'JSON',
            cache: false,
            contentType: false,
            processData: false,
    ...
    function save() {
        ...
        if (nama === '') {
            ...
            var url = "";
            if (save_method === 'add') {
                url = "<?php echo base_url(); ?>profileuser/ajax_add_keluarga";
            } else {
                url = "<?php echo base_url(); ?>profileuser/ajax_edit_keluarga";
            }
            $.ajax({
                url: url,
                type: "POST",
    ...
    function hapus(id, no) {
        if (confirm("Apakah anda yakin menghapus keluarga nomor " + no + " ?")) {
            $.ajax({
                url: "<?php echo base_url(); ?>profileuser/hapuskeluarga/" + id,
                type: "POST",
                dataType: "JSON",
                success: function (data) {
                    iziToast.success({
    ...
    function ganti(id) {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>profileuser/gantikeluarga/" + id,
            type: "POST",
            dataType: "JSON",
            success: function (data) {
    ...
    function simpan_sip(){
        ...
        if(no_sip === ""){
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>profileuser/prosessip",
                dataType: 'JSON',
                cache: false,
                contentType: false,
                processData: false,
    ...
    function unduh(kode){
        window.location.href = "<?php echo base_url(); ?>profileuser/unduhfile/"+kode;
    }
        ...
        <div class="section-body">
            <nav>
                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                    <a class="nav-item nav-link active" id="nav_tab_singkat" data-toggle="tab" href="#nav_singkat" role="tab" aria-controls="nav_singkat" aria-selected="true">Identitas Singkat</a>
                    <a class="nav-item nav-link" id="nav_tab_diri" data-toggle="tab" href="#nav_diri" role="tab" aria-controls="nav_diri" aria-selected="true">Identitas Lengkap</a>
            ...
            <div class="tab-content" id="nav-tabContent" style="background-color: white;">
                <div class="tab-pane fade show active" id="nav_singkat" role="tabpanel" aria-labelledby="nav_singkat" style="background-color: white;">
                    <div class="card">
                        <div class="card-body">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input id="nrp" name="nrp" class="form-control" type="text" autocomplete="off" value="<?php echo $nrp_user; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input id="nama" name="nama" class="form-control" type="text" autocomplete="off" value="<?php echo $nama_user; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <select id="pangkat" name="pangkat" class="form-control">
                                                    ...
                                                    foreach ($pangkat->result() as $row) {
                                                        if($row->idpangkat == $idpangkat_user){
                                                            ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <button id="btnSaveDepan" type="button" onclick="simpandepan();" class="btn btn-block btn-primary"> Save </button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="tab-pane fade" id="nav_diri" role="tabpanel" aria-labelledby="nav_diri" style="background-color: white;">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
